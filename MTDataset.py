...
class MTDataset(DataLoader):
    def __init__(self, root_dir, image_set, n_class, mode = None):
        ...
        for img_name in self.img_list:
            ...
            target_filename = os.path.join(root_dir, 'labels/{:s}'.format(os.path.splitext(img_name)[0] + '.png'))
    ...
    def __getitem__(self, index):
        ...
        if os.path.basename(os.path.splitext(self.targets[index])[0] + '.jpg') in labeled_image_list or self.image_set =='val':
